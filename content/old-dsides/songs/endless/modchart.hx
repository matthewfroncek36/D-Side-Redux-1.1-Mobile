...
function onLoad() {
	holdSubdivisions = (ClientPrefs.modcharts && !ClientPrefs.lowQualty) ? 4 : 1;
}
...
function onCreatePost() {
	...
	var kicks = [
		16, 80, 90, 96, 106, 112, 120, 128, 132, 136, 140, 140.5, 141, 141.5, 142, 142.5, 143, 143.5,
	];
	...
	modManager.queueSet(1312, "sudden", 1);
	modManager.queueSet(1312, "suddenOffset", 5);
	...
	var kicks = [
		1440, 1504, 1568, 1578, 1584, 1594, 1600, 1610, 1616, 1626, 1632, 1642, 1648, 1658, 1664, 1674, 1680, 1690,
	];
